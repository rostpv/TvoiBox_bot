...
Статус: передача завершена, production работает на сервисах нового владельца. После передачи дополнительно реализованы web-запись клиента вне Telegram и резервный web-кабинет тренера.
...
- [x] Web-запись клиента вне Telegram открывается и использует общий контур заявок/слотов.
- [x] Web-кабинет тренера открывается и использует общий `TrainerMiniApp`.
- [x] Web-заявки попадают в общий тренерский контур с источником `Web`.
