...
Бот отвечает на /start: да, проверено 2026-06-03
Кнопка mini app появилась: да, проверено 2026-06-03
Mini app открывается: да, проверено 2026-06-03
...
- [x] Открыть production-бота в Telegram.
- [x] Нажать `/start`.
- [x] У клиента появилась кнопка `Открыть mini app`.
- [x] Mini app открывается внутри Telegram.
